		...
		<center>
		  <blockquote>
			  <h3>En esta sección</h3>
				<footer>Por cada médico seleccionado, se podrá realizar las sgtes funcionalidades:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</footer>
				<p><font size='2'>Crear Nueva Agenda: se mostrarán todos los box y su horario con respecto  </br> &nbsp;a la especialidad del médico   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;        </font> </p>
          ...
          <tr>
            ...
            $PTD_NOMBRE = $row['PTD_NOMBRE'];
						...
						$sqlCantConvMed =  "select * from ab_documento, ab_historial 
where ab_documento.doc_codigo = ab_historial.doc_codigo and
ab_documento.PTD_RUT = '$PTD_RUT'";

						$buscarCantConvMed = sqlsrv_query($conexion, $sqlCantConvMed , $params, $options);

						$row_countCantConvMed = sqlsrv_num_rows( $buscarCantConvMed ); 
           ...
           <td> <a href='verBoxEspecialidadMed.php?PTD_RUT=<?php echo $PTD_RUT;?>' class="modificar" > Crear Nueva Agenda </a>  </td>
            </tr>
            <?php
            }
