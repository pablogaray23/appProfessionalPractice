    ...
    <div class="wrapper">
      ...
      <div class="box box-info">
                <div class="box-header with-border">
                  <center> <h3 class="box-title">Modificar Nuevo Médico</h3> </center>
                </div>
                <div class="box-body">
        <div class="col-lg-6 col-lg-offset-3">
		
		
		<form  class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="modiMedicoBaseDatosDos.php">
		...
		<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							 <input  id="PTD_RUT" name="PTD_RUT" value="<?php echo $PTD_RUT; ?>" class="form-control" readonly="readonly" placeholder="R.U.T. Médico" type="text">
						</div>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input  id="PTD_NOMBRE" name="PTD_NOMBRE" value="<?php echo $PTD_NOMBRE; ?>" class="form-control" placeholder="Nombre Médico" type="text">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				 <input  id="PTD_APELLIDOP" name="PTD_APELLIDOP" value="<?php echo $PTD_APELLIDOP; ?>" class="form-control" placeholder="Apellido Paterno Médico" type="text">
				...
				<div class="col-sm-10">
					<input  id="PTD_APELLIDOM" name="PTD_APELLIDOM" value="<?php echo $PTD_APELLIDOM; ?>" class="form-control" placeholder="Apellido Materno Médico" type="text">
				...
				<div class="col-sm-10">
					 <input  id="PTD_DIRECCION" name="PTD_DIRECCION" value="<?php echo $PTD_DIRECCION; ?>" class="form-control" placeholder="Dirección Médico" type="text">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					   <input  id="CORREO" name="CORREO" value="<?php echo $CORREO; ?>" class="form-control" placeholder="Correo Electrónico Médico" type="email">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					   <input  id="ESP_NOMBRE" name="ESP_NOMBRE" value="<?php echo $ESP_NOMBRE; ?>" class="form-control" readonly="readonly"  placeholder="Especialidad Médico" type="text">
