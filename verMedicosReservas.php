 ...
 <ul class="sidebar-menu">
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li ><a  href="asignarPreReservaMed.php"> Crear Agenda </a></li>
				<li ><a  href="asignarPreReservaMed.php"> Ver Agenda Médico </a></li>
				<li class="active" ><a  href="verMedicosReservas.php"> Gestión Reservas </a></li>
              </ul>
            </li>
          ...
          <div class="box-body">
                  <table id="example1" style="text-align:center;" class="table table-bordered table-striped table-condensed">
					...
					<tr>
						...
						<td><a href='gestionMedReservas.php?PTD_RUT=<?php echo $PTD_RUT; ?>'> Gestionar Reservas </td>
					</tr>
						<?php
						}
