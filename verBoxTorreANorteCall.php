...
$link=conexion();
$sql = "select * from ab_box where box_torre = '1' and box_ala = 'Ala Norte'";
   ...
   <!-- Sidebar Menu -->
            ...
            <!-- Optionally, you can add icons to the links -->
			 ...
			 <li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a  href="verBoxTorreANorteCall.php"> Ver Boxs Torre Antigua - Ala Norte </a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Gesti&oacute;n
            <small>Ver Ocupación Ala Norte</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Box</li>
			<li class="active">Ala Norte</li>
          </ol>
        </section>
