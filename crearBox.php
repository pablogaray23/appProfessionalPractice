    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Gesti&oacute;n
            <small> Crear Box </small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Box</li>
			 <li class="active">Crear Box</li>
          </ol>
        </section>
      ...
      <div class="box box-info">
		...
		<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="crearBoxBaseDatos.php">     

			<div class="form-group">
				<label for="PTD_RUT" class="col-sm-2 control-label"> Número Box </label>
				<div class="col-sm-10">
					 <input  id="box_numero" name="box_numero" class="form-control" placeholder="Número Box" type="text">
					<font color='blue'> Máximo 3 dígitos </font>
				</div>
			</div>
			<div class="form-group">
             ...
             <div class="form-group">
				...
				<div class="col-sm-10">
					<select id="box_piso" name="box_piso" class="form-control">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select id="box_torre" name="box_torre" class="form-control">
                      <option>Torre Antigua</option>
                      <option>Torre Nueva</option>
                    </select>
            ...
            <div class="form-group">
				...
				<div class="col-sm-10">
					<select id="box_ala" name="box_ala" class="form-control">
   ...
   function crearBox(){
    ...
    var ala=$('#ala').val();
     ...
     $.ajax({
        ...
        data: 'numero='+numero+'&codigoA='+codigoA+'&piso='+piso+'&torre='+torre+'&ala='+ala,
