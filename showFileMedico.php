 ...
 <ul class="sidebar-menu">
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a  href="showFileMedico.php"> Ver Documentos </a></li>
          ...
          <div class="box-body">
                  <table id="example1" style="text-align:center;" class="table table-bordered table-striped table-condensed">
					...
					<tr>
						...
						<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onClick="modificarProfesor('<?php echo $$PTD_RUT; ?>')"> Modificar</button></td>
					</tr>
						<?php
						}
			...
			$.ajax(
				{
					dataType: 'json',
					type: 'POST',
					url: "modificarEstudianteBaseDeDatos.php",
					data: 'rut='+idUser,
					success: function(valor){
						...
						if(valor!="Ocurrio un error intentelo nuevamente"){
							...
							$("#apellidoP").val(valor.apellidoP);
							$("#apellidoM").val(valor.apellidoM);
							$("#direccion").val(valor.direccion);
							$("#telefono").val(valor.telefono);
							$("#nivel").val(valor.nivel);
