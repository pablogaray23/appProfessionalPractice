...
$queryEspecialidadCien= sqlsrv_query($link, "select * from ab_especialidad_prestador where ab_especialidad_prestador.PTD_RUT = '$PTD_RUT'");
  //$nmyestudiante = sqlsrv_num_rows($estudiante);
  $rowEspecialidadCien = sqlsrv_fetch_array($queryEspecialidadCien);
  $especialidadMedicoCien = $rowEspecialidadCien['ESP_CODIGO'];
...
and ab_box_especialidad.esp_codigo = '$especialidadMedicoCien'
...
?>
            ...
            <li class="treeview active">
			  ...
			  <li ><a  href='crearMedico.php?PTD_RUT="#"'> Crear Médico </a></li>
			   <li ><a  href="medicoGestionar.php"> Gestionar Médico </a></li>
				...
				<li class="active"><a  href="createAgendaMedicaAdmin.php"> Crear Agenda por Médico </a></li>
              </ul>
            </li>
		  ...
		  <center> <h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Especialidad Médico : <?php echo $especialidadMedico; ?> </h4> </center>
               ...
               <table id="example1" style=" width:100%; height:50%; text-align:center;"  class="table table-bordered table-striped table-condensed">
			      ...
			      <?php
					...
					<td><center>  </center></td>
					<td><center>  </center></td>
					<td><center> <font color='red' > Médicos sin horarios en box </font> </center></td>
					<td><center>  </center></td>
					<td><center>  </center></td>
					<td><center>  </center></td>
					</tr>
  ...
  $numeroBox = $rowNumeroBox['box_numero'];
   ...
   $acb_codigo_actividad = $rowNumeroBox['acb_codigo_actividad'];
  $box_ala = $rowNumeroBox['box_ala'];
...
HAVING COUNT(*) > 0";
						...
						echo "</tbody>";
								...
								echo "<h4> <a href='crearAgendaMedicoNueva.php?box_codigo=$box_codigo &PTD_RUT=$PTD_RUT'> Crear Nueva Agenda </a></h4>";
