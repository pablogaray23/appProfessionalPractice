 ...
 <ul class="sidebar-menu">
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a  href="medicoModificar.php"> Ver Médico </a></li>
				...
				<li><a  href="asignarPreReservaMed.php"> Crear Pre - Reserva </a></li>
          ...
          <div class="box-body">
                  <table id="example1" style="text-align:center;" class="table table-bordered table-striped table-condensed">
					...
					<tr>
						...
						<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onClick="medicoModificar('<?php echo $PTD_RUT ; ?>')"> Ver Médico </button></td>
					</tr>
						<?php
						}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                  ...
                  <div class="input-group">
                    ...
                    <input   id="PTD_NOMBRE"  class="form-control"  type="text">
                  </div>
				   <br>
				   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-child"></i></span>
                    <input  id="ESP_NOMBRE" class="form-control" readonly type="email">
                  </div>
                  <br>
