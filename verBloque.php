...
die( print_r( sqlsrv_errors(), true));
  ...
  $paraNumeroBox = $rowNumeroBox['box_numero'];
				  ...
				  <div class="input-group">
                    <span class="input-group-addon"><p> Modifique Estado Reserva </p></span>
                  </div>
				   <br>
				  <div class="input-group">
          ...
          <div class="box-footer">
                   <center><input type="submit" name="btn-upload" value="Actualizar Agenda"></center>
				  </div>
				  
				  <div class="box-footer">
                   <center><a href='eliminarAgendaMedico.php?PTD_RUT=<?php echo $PTD_RUT;?> &agm_codigo= <?php echo $agm_codigo;?> &agd_id_agendaDetalle= <?php echo $agd_id_agendaDetalle;?>'  class="confirmation"  > Eliminar Agenda </a></center>
				  </div>
