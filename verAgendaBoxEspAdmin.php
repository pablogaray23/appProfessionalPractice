...
if ($row_count != 0){
 ...
 json_encode($blocks);
	...
	$blocks[] = array('id' => null, 'rut' => null, 'name' => null, 'apellido' => null, 'estado' => null, 'nameDos' => null, 'day' => null, 'startTime' => null,
			'endTime' => null);
	 json_encode($blocks);
	 echo "<center> <h3> <font size ='3', color ='red'> No tiene horario para esta esp. </font> </h3> </center>";
  ...
  $box_ala = $rowDatosBox['box_ala'];
						  ...
						  if($acb_codigo_actividad=='1'){
							...
							if($contador==0)								
								...
								echo "<center><font color='black'> Ala Box  :   </font><font color='black' size='3px'> $box_ala </font></center>";
