    ...
    for ($j = 2; $j < 8; $j++) {
        ...
        foreach ( $blocks as $block ) {
            ...
            if ( ( $block["day"] == $j ) && ( $block["startTime"] == $i ) ) {
                ...
                $blockID    = $block["id"];
               $rowContent .= "\t" . "<td class='forcedWidth' style='line-height:8px; width:1000px; height:100%;' bgcolor='$lala'  rowspan='$rowspan'   data-id='$blockID' class='block-cell'> <a href='verBloque.php?PTD_RUT=$blockID'> <font color='$lele'> $content </br> $contentTres </br> $contentDos  </font> </a>  </td>" . "\r\n";
