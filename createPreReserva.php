...
die( print_r( sqlsrv_errors(), true));
	...
	$sqlTres = "select  ab_box_especialidad.esp_codigo, especialidad.ESP_NOMBRE, ab_box_especialidad.box_codigo
from ab_box_especialidad
inner join especialidad
on ab_box_especialidad.esp_codigo = especialidad.ESP_CODIGO where box_codigo='$box_codigo'";
 ...
 <ul class="sidebar-menu">
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
				...
				<li ><a  href="adddirDocumentoMedico.php"> Añadir Documentos </a></li>
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a  href="boxModificarEspecialidad.php"> Asignar Esp. Box </a></li>
	...
	<li class="treeview">
      ...
      <div class="box box-info">
                <div class="box-header with-border">
                  <center>
				  <h3 class="box-title"> Asignar Especialidad a Box</h3>
				  </center>
                </div>
                <div class="box-body">
        <div class="col-lg-6 col-lg-offset-3">
                  ...
                  <form method="post" enctype="multipart/form-data" action="addEspBoxBaseDatosTres.php">
				  
				  <div class="input-group">
                    <span class="input-group-addon"><p> Código Box</p></span>
                    <input  id="box_codigo" name="box_codigo" value="<?php echo $box_codigo; ?>" class="form-control" readonly="readonly" placeholder="Código Box" type="email">
                  </div>
                  ...
                  <div class="input-group">
				   ...
				   <table id="example1" style="text-align:center;" class="table table-bordered table-striped table-condensed">
                    <thead>
                      <tr>
                        <th><center> Código Especialidad </center></th>
