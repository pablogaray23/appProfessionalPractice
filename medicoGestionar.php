      ...
      <div class="content-wrapper">
        ...
        <section class="content">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>RUT Médico</th>
                        <th>Nombre Médico</th>
						<th>Apellido Paterno Médico</th>
                        <th>Editar</th>
						<th><center>Editar Especialidad</center></th>
          ...
          <tr>
			...
			<td><?php echo $PTD_APELLIDOP; ?></td>

           <td> <a href='modificarMedico.php?PTD_RUT=<?php echo $PTD_RUT;?>' class="modificar"  > <img align=center src="imagenes/edit_write_icon_T.png" height="42" width="42"> </a>  </td>
		   <td> <a href='medicoModificarEspecialidad.php?PTD_RUT=<?php echo $PTD_RUT;?>' class="modificar"  > <center> <img align=center src="imagenes/5109.png" height="42" width="42"> </center> </a>  </td>
           <td> <a href='eliminarMedico.php?PTD_RUT=<?php echo $PTD_RUT;?>'  class="confirmation"  > <center> <img align=center src="imagenes/recycle_bin-512.png" height="42" width="42"> </center></a>  </td>
 ...
 <!-- jQuery 2.1.4 -->
	...
	<script type="text/javascript">
		...
		var confirmIt = function (e) {
			if (!confirm('¿Desea eliminar definitivamente al médico?')) e.preventDefault();
		};
