    ...
    for ($j = 2; $j < 8; $j++) {
        ...
        foreach ( $blocks as $block ) {
            ...
            if ( ( $block["day"] == $j ) && ( $block["startTime"] == $i ) ) {
                ...
                $blockID    = $block["id"];
               $rowContent .= "\t" . "<td class='forcedWidth' style='line-height:8px; width:1000px; height:100%;' bgcolor='$lala'  rowspan='$rowspan'   data-id='$blockID' class='block-cell'> <a href='verBloqueCentro.php?PTD_RUT=$blockID'> <font color='$lele'> $content </br> $contentTres </br> $contentNueve </br> $contentDiez  </font> </a>  </td>" . "\r\n";
            ...
            <li class="treeview">
			 ...
			 <li class="treeview active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a  href="boxVerPorEspCentro.php"> Ver Boxs Por Esp. </a></li>
